...
public class NotificationMgr implements CallerInfoAsyncQuery.OnQueryCompleteListener{
    ...
    // used to track the missed calls
    ...
    /* package */ void notifyMissedCall(
        ...
        if (PhoneUtils.PhoneSettings.isBreathEnabled(mContext)) {
    ...
    void cancelMissedCallNotification() {
        // reset the list of missed calls to 0.
        mMissedCalls.clear();
    ...
    /* package */ void notifyBlacklistedCall(String number, long date, int matchType) {
        ...
        if (addUnblockAction) {
            ...
            builder.addAction(R.drawable.ic_unblock_contact_holo_dark,
                    ...
                    PhoneApp.getUnblockNumberFromNotificationPendingIntent(mContext, number));
        }
